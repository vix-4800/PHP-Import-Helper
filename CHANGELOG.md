...
- Reworked namespace indexing to use Composer autoload roots for project code and Composer-generated vendor class maps instead of scanning every workspace PHP file.
- Bumped the persisted namespace index format so existing caches rebuild with Composer-aware sources.
